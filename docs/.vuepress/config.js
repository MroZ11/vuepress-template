module.exports = {
  base: '/docs/', //目标地址是：https://openhacking.github.io/vuepress-template/，所以需要配置base地址后缀
  locales: {
    // 键名是该语言所属的子路径
    // 作为特例，默认语言可以使用 '/' 作为其路径。
    '/': {
    ...
    locales: {
      '/': {
        ...
        nav: [
          ...
          { text: 'Q&A', link: '/qa/', ariaLabel: 'Q&A' },
          { text: 'Github', link: 'https://github.com/MroZ11/vuepress-template' }
        ],
        sidebar: {
          '/guide/': [
            '',
      ...
      '/zh/': {
        ...
        nav: [
          ...
          { text: '常见问题', link: '/zh/qa/', ariaLabel: '常见问题' },
